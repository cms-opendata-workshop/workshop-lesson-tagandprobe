...
> ## Challenge
>
> Using what you did before, try to mix them and plot a comparison **between data from the sideband method and data from the fitting method** and get an analysis.
> Notice that:
>
> * Real data = Run 2011
